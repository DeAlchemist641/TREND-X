...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "trend-x~mxYXWCKT#jyZqeElUhDDgehn-dxtqFyZ_H9lVQGjPKYljkxOxz2U",
// add your Session Id 
...
BOT_NAME: process.env.BOT_NAME || "FRANK-X",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "FRANK-X",
...
LIVE_MSG: process.env.LIVE_MSG || "> Powered by *FRANK-X TECH*⚡",
// add alive msg here 
